...
<table width="770" border="0" cellpadding="0" cellspacing="0" align="center" class="t0">
	<tr>
		<td width="270" class="t2">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
				<tr>
					...
					<td width="200" height="200" class="t4">
						<!--<img src="css/images/pic.png" class="t5">-->
					</td>
					<td>
						&nbsp;
					</td>
		...
		<td class="t3">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
				<tr>
					...
					<td width="70%" height="200">
						<h1 class="t6">Alex</h1>
						<hr class="t7b"/>
						<h2 class="t7">Senior Cloud Consultant</h2>
						<hr class="t7b"/>
						<h3 class="t7a">Dublin, Ireland</h3>
					</td>
					<td class="t8">
						&nbsp;
					</td>
				...
				<tr>
					<td colspan="3">
						<div class="t7c">
							...
							<h2 align="left">Lacus mattis euismod risus</h2>
							<h3>Pellentesque quis accumsan</h3>
							<p>Donec nec lacus mattis turpis accumsan imperdiet sed ut dolor. Vivamus in euismod turpis. Pellentesque pharetra lectus libero, nec mollis ligula convallis ut. Donec eget velit vel ligula bibendum fringilla. In libero ante, efficitur eget fringilla hendrerit, luctus non mi. Curabitur sit amet convallis risus, vel sollicitudin purus. Nunc mattis enim in ligula pulvinar tempor. Morbi tristique purus ultrices sem placerat malesuada. Vestibulum nec lectus eget leo egestas finibus. Sed ultrices eros ut erat dapibus laoreet. Aliquam id hendrerit tellus, eget luctus lacus. Aliquam eleifend dolor sed metus efficitur fermentum.</p>
						</div>
